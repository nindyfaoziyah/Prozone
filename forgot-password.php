                ...
                try {
                    ...
                    if ($result) {
                        ...
                        if (defined('EMAIL_DEBUG') && EMAIL_DEBUG) {
                            ...
                            $success_message = 'Link reset password telah dibuat!<br><br>
                                <div style="background: rgba(59, 130, 246, 0.1); padding: 1rem; border-radius: 8px; margin-top: 0.5rem;">
                                    <strong style="color: #3b82f6;">&nbsp;&#x1F527;&nbsp; Mode Development</strong><br>
                                    <small style="color: #94a3b8;">Email dilog ke /logs/emails.log</small><br><br>
                                    <a href="' . htmlspecialchars($resetLink) . '" style="color: #2563eb; word-break: break-all;">Klik di sini untuk reset password</a>
                                </div>';
                        } else {
                    ...
                    try {
                        ...
                        if ($result) {
                            if (defined('EMAIL_DEBUG') && EMAIL_DEBUG) {
                                $resetLink = $emailService->getLastResetLink();
                                $success_message = 'Link reset: <a href="' . htmlspecialchars($resetLink) . '" style="color: #2563eb;">Klik di sini</a>';
                            } else {
